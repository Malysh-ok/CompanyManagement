...
..\..\4.Infrastructure\Phrases\Phrases.csproj".Replace("`r", "").Split("`n")
                ...
                dotnet ef migrations add $MigrationName -o Migrations -p "D:\Документы\_ПРОЕКТЫ\_Программирование\C#\Тестовые задания 2023.06\CompanyManagement\3.DataAccess\Migrator\Migrator.csproj" -v  -- --migrationsAssembly Migrator
                pause
