...
..\..\4.Infrastructure\Phrases\Phrases.csproj".Replace("`r", "").Split("`n")
                ...
                dotnet ef migrations remove -p "D:\Документы\_ПРОЕКТЫ\_Программирование\C#\Тестовые задания 2023.06\CompanyManagement\3.DataAccess\Migrator\Migrator.csproj" -s $dbContextProjPath -v  -- --migrationsAssembly Migrator
                pause
